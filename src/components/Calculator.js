...
const Card = () => {
    return (
        <div>
           <div className="calcard flex flex-col gap-10 place-content-evenly w-80 bg-base-100 shadow-xl p-10 rounded-t-3xl rounded-bl-3xl rounded-br-70 md:w-10/12  md:mt-10  md:ml-10 ">

            <div className="date flex flex-row place-content-evenly gap-5 md:w-2/3 md:gap-10">
            ...
            <div className="logo w-16 h-16 rounded-full bg-purple flex items-center justify-center z-20 md:absolute  md:right-0  md:w-20  md:h-20">
            ...
            <div className="w-1/2 h-0.5 bg-light-grey w-72 absolute top-8 md:w-11/12  md:absolute  md:top-10  md:left-0"></div>
            </div>


                
            <div className="age flex flex-col items-start font-poppins font-bold italic text-5xl md:text-8xl  md:mt-10">
                    <div>
